...
template<class _Index, class _Item, class _ClusterAttr>
class IndexWrapper {
    typedef typename _Index::HMap Map;
    typedef typename Map::Item ClusterNode;
    
public:
    typedef typename _Index::HKey Key1;
    typedef _Item Item;
...
template<class _Index, class _Item, class _ClusterAttr>
class GroupViewIterator {
    typedef typename _Index::HMap::Iterator MapIter;
...
class GroupView {
    ...
    typedef typename Index::HKey::AttrS KeyAttrS;
...
private:
    ...
    typedef typename Index::HKey Key;
    typedef typename Index::Cluster Cluster;
    typedef typename Index::Item SrcTup;
