...
friend inline size_t hash(const NamedTuple& t)
    { return t.foldl(st_detail::hash_value_folder(), 0ul); }
...
template <class _T> struct GetAttrS { typedef typename _T::AttrS R; };
