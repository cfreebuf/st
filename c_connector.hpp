    ...
    struct HR<Pair<Int<_TABLE_POS2>, _Table2> > {
        struct other_table {
            ...
            typedef TCAP(getIteratorFromSeekInfo,
                         typename TS::SeekInfo, _Table2) R;
        };
...
class Connector : public c_show_base {
    // internal types
    typedef TCAP(list_map, unmark_silent, class _From::ArgL) SrcMTableL_;
    ...
    typedef TCAP(normalize_pred_list, class _Where::PredL) NPS1;
